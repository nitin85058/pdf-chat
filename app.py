...
import os
HF_TOKEN="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"
...
# Ensure that you provide the proper configuration
    ...
    persist_directory="/path/to/store" # The directory to persist the data
     # Specify your tenant, if needed
    # Other necessary settings
)


# Now when initializing Chroma
